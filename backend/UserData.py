def store_user_data(user_token):
...
def calculate_match(person1: dict, person2: dict) -> bool:
    """Given two users, accesses the database to retrieve the user's
    listening data and uses that data to determine their compatibility"""
    raise NotImplemented